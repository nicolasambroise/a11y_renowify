...
if(typeof nia_formFields !== 'undefined'){
	...
	nia_formFields.forEach(item => {
		...
		else if(item.tagName == "INPUT" && (item.getAttribute("name") == "email" || item.getAttribute("type") == "email") && (!item.hasAttribute("autocomplete") || item.getAttribute("autocomplete") != "email")) {
			color="orange";
			label = 'autocomplete="'+item.getAttribute("autocomplete")+'" --> email ?';
			nia_formWarning++;
		}
		else if(item.tagName == "INPUT" && (item.getAttribute("name") == "tel" || item.getAttribute("name") == "phone" || item.getAttribute("name") == "telephone" || item.getAttribute("type") == "tel") && (!item.hasAttribute("autocomplete") || item.getAttribute("autocomplete") != "tel")) {
			color="orange";

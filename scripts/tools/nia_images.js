...
if(typeof nia_images !== 'undefined'){
	...
	nia_images.forEach(item => {
		...
		if(item.tagName == "IMG" || (item.hasAttribute("role") && item.getAttribute("role") == "img")){
			nia_imgElm++;
	...
	nia_imgBottomLine.innerHTML = "Images : "+nia_imgElm+" img - "+nia_imgSvg+" svg - "+nia_imgObject+" object <br>"+nia_imgWarning+" warning(s) - "+nia_imgError+" error(s)";

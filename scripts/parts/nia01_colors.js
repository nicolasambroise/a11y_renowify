...
function check_part_01(){
	...
	if(!only_redactor){
		...
		if(nia01a_nodes && nia01a_nodes.length > 0){
			for(let i = 0; i < nia01a_nodes.length; i++){
				if(isItemVisible(nia01a_nodes[i]) && !isItemSROnly(nia01a_nodes[i]) && isItemHasVisibleContent(nia01a_nodes[i]) && isItemHasDirectContent(nia01a_nodes[i])){
					nia01a_color1 = window.getComputedStyle(nia01a_nodes[i],null).getPropertyValue('color');  // Text Color
					...
					nia01a_color1luminance = luminance(nia01a_color1rgb.r, nia01a_color1rgb.g, nia01a_color1rgb.b);
					nia01a_color2luminance = luminance(nia01a_color2rgb.r, nia01a_color2rgb.g, nia01a_color2rgb.b);
					// Calcul ratio
					nia01a_ratio = nia01a_color1luminance > nia01a_color2luminance ? ((nia01a_color2luminance + 0.05) / (nia01a_color1luminance + 0.05)) : ((nia01a_color1luminance + 0.05) / (nia01a_color2luminance + 0.05));
					nia01a_ratio_inv = 1/nia01a_ratio;
					
					nia01a_large = parseFloat(window.getComputedStyle(nia01a_nodes[i],null).getPropertyValue('font-size'));
					nia01a_bold = window.getComputedStyle(nia01a_nodes[i],null).getPropertyValue('font-weight');
					nia01a_isbold = false;
					if(nia01a_bold == "bold" || nia01a_bold == "bolder" || nia01a_bold >= 500) {nia01a_isbold = true;}
					...
					else if(nia01a_nodes[i].tagName == "A" || nia01a_nodes[i].tagName == "BUTTON"){
		...
		if(nia01a_flag1 == true) {
		  setItemToResultList("dev","<li><a href='#' data-destination='nia01a' class='result-focus label-orange'>01-A</a> : Présence d'éléments textuels insuffisament contrasté</li>");
		}
		if(nia01a_flag2 == true) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01a' class='result-focus label-yellow'>01-A</a> : Vérifier le contraste de certains éléments textuels</li>");
		}
	}
	...
	if(!only_redactor){
		...
		let nia01b_color1, nia01b_color2, nia01b_color3, nia01b_color1rbg, nia01b_color2rbg, nia01b_color3rgb, nia01b_color1luminance, nia01b_color2luminance, nia01b_color3luminance;
		let nia01b_ratio12, nia01b_ratio12_inv,nia01b_ratio13, nia01b_ratio13_inv,nia01b_ratio23, nia01b_ratio23_inv;
		if(nia01b_nodes && nia01b_nodes.length > 0){
			for(let i = 0; i < nia01b_nodes.length; i++){
				if(isItemVisible(nia01b_nodes[i]) && !isItemSROnly(nia01b_nodes[i]) && !isItemDisplayNone(nia01b_nodes[i])){
					nia01b_color1 = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('border-color');  // Border Color
					nia01b_color2 = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('background-color');  // In BG Color
					nia01b_color3 = getInheritedBackgroundColor(nia01b_nodes[i].parentElement) // Out BG Color
					nia01b_border = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('border-width');  // Border
					nia01b_position = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('position');  // Border

					if(nia01b_color1.length >20) nia01b_color1 = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('border-bottom-color');
					if(nia01b_color1 == "rgba(0, 0, 0, 0)") nia01b_color1 = window.getComputedStyle(nia01b_nodes[i],null).getPropertyValue('border-bottom-color');
					...
					if(nia01b_color2 == "rgba(0, 0, 0, 0)" && (nia01b_position == "absolute" || nia01b_position == "fixed")){
						...
						if(nia01b_color2.indexOf("#") >= 0){ nia01b_color2rgb = hexToRgbArray(nia01b_color2);} else {nia01b_color2rgb = rgbToRgbArray(nia01b_color2);}
						if(nia01b_color3.indexOf("#") >= 0){ nia01b_color3rgb = hexToRgbArray(nia01b_color3);} else {nia01b_color3rgb = rgbToRgbArray(nia01b_color3);}
						
						nia01b_color2luminance = luminance(nia01b_color2rgb.r, nia01b_color2rgb.g, nia01b_color2rgb.b);
						nia01b_color3luminance = luminance(nia01b_color3rgb.r, nia01b_color3rgb.g, nia01b_color3rgb.b);
						// Calcul ratio
						nia01b_ratio23 = nia01b_color2luminance > nia01b_color3luminance ? ((nia01b_color2luminance + 0.05) / (nia01b_color3luminance + 0.05)) : ((nia01b_color3luminance + 0.05) / (nia01b_color2luminance + 0.05));
						...
						if(nia01b_ratio23 < 3 && nia01b_ratio23_inv <3){
							if(debug_flag){
								...
								console.log("01B - FAIL 3.3.3 Standard ratio : "+nia01b_ratio23_inv+" ("+nia01b_color2+" vs "+nia01b_color3+")");
							}
					...
					// Convert hexa
						...
						if(nia01b_color1.indexOf("#") >= 0){ nia01b_color1rgb = hexToRgbArray(nia01b_color1);} else {nia01b_color1rgb = rgbToRgbArray(nia01b_color1);}
						if(nia01b_color2.indexOf("#") >= 0){ nia01b_color2rgb = hexToRgbArray(nia01b_color2);} else {nia01b_color2rgb = rgbToRgbArray(nia01b_color2);}
						if(nia01b_color3.indexOf("#") >= 0){ nia01b_color3rgb = hexToRgbArray(nia01b_color3);} else {nia01b_color3rgb = rgbToRgbArray(nia01b_color3);}
						nia01b_color1luminance = luminance(nia01b_color1rgb.r, nia01b_color1rgb.g, nia01b_color1rgb.b);
						nia01b_color2luminance = luminance(nia01b_color2rgb.r, nia01b_color2rgb.g, nia01b_color2rgb.b);
						nia01b_color3luminance = luminance(nia01b_color3rgb.r, nia01b_color3rgb.g, nia01b_color3rgb.b);
						// Calcul ratio
						nia01b_ratio12 = nia01b_color1luminance > nia01b_color2luminance ? ((nia01b_color2luminance + 0.05) / (nia01b_color1luminance + 0.05)) : ((nia01b_color1luminance + 0.05) / (nia01b_color2luminance + 0.05));
						nia01b_ratio12_inv = 1/nia01b_ratio12;
						nia01b_ratio13 = nia01b_color1luminance > nia01b_color3luminance ? ((nia01b_color3luminance + 0.05) / (nia01b_color1luminance + 0.05)) : ((nia01b_color1luminance + 0.05) / (nia01b_color3luminance + 0.05));
						...
						if( nia01b_ratio12_inv < 3 && nia01b_ratio13_inv < 3 && nia01b_ratio23_inv < 3){
							...
							if(debug_flag && nia01b_ratio12_inv < 3) console.log("01B - FAIL 3.3.3 Standard ratio : "+nia01b_ratio12_inv+" ("+nia01b_color1+" vs "+nia01b_color2+")");
							else if(debug_flag && nia01b_ratio13_inv < 3) console.log("01B - FAIL 3.3.3 Standard ratio : "+nia01b_ratio13_inv+" ("+nia01b_color1+" vs "+nia01b_color3+")");
							else if(debug_flag && nia01b_ratio23_inv < 3) console.log("01B - FAIL 3.3.3 Standard ratio : "+nia01b_ratio23_inv+" ("+nia01b_color2+" vs "+nia01b_color3+")");
							setItemOutline(nia01b_nodes[i],"orange","nia01b2","01-B");
							nia01b_flag3 = true;
						}
					}
		...
		if(nia01b_flag1 == true ) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01b1' class='result-focus label-yellow'>01-B</a> : Présence d'élément graphique avec background transparent sur un élément en position absolute - Contraste à vérifier manuellement</li>");
		}
		if(nia01b_flag2 == true ) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01b1' class='result-focus label-yellow'>01-B</a> : Présence d'élément graphique avec background transparent - Contraste à vérifier manuellement</li>");
		}
		if(nia01b_flag3 == true) {
		  setItemToResultList("dev","<li><a href='#' data-destination='nia01b2' class='result-focus label-orange'>01-B</a> : Présence d'élément graphique insuffisament contrasté</li>");
		}
		if(nia01b_flag4 == true) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01b1' class='result-focus label-yellow'>01-B</a> : Présence d'élément graphique avec background identique au fond de page - Contraste à vérifier manuellement</li>");
		}
	}
	...
	if(!only_redactor && !only_error){
		const nia01c_btn = document.querySelector('button.anchor[data-destination="#topsearch"][aria-expanded="false"]');
		if(nia01c_btn){nia01c_btn.click();}
		const nia01c_nodes = document.querySelectorAll('input[placeholder]:not([disabled])');
		let nia01c_flag1 = false;
		let nia01c_flag2 = false;
		let nia01c_flag3 = false;
		let nia01c_color1,nia01c_color2,nia01c_color1rbg, nia01c_color2rbg,nia01c_color1luminance, nia01c_color2luminance, nia01c_ratio,nia01c_ratio_inv,nia01c_opacity;
		if(nia01c_nodes && nia01c_nodes.length > 0){
			for(let i = 0; i < nia01c_nodes.length; i++){
				if(isItemVisible(nia01c_nodes[i])){
					nia01c_color1 = window.getComputedStyle(nia01c_nodes[i],'::placeholder').getPropertyValue('color');  // Placeholder Color
					nia01c_color2 = getInheritedBackgroundColor(nia01c_nodes[i]) // Bg Color
					nia01c_opacity = window.getComputedStyle(nia01c_nodes[i],'::placeholder').getPropertyValue('opacity');  // Placeholder Color
					
					//console.log("01C "+nia01c_color1+" vs "+nia01c_color2);
					// Convert hexa
					if(nia01c_color1){
						if(nia01c_color1.indexOf("#") >= 0){ nia01c_color1rgb = hexToRgbArray(nia01c_color1);} else {nia01c_color1rgb = rgbToRgbArray(nia01c_color1);}
						if(nia01c_color2.indexOf("#") >= 0){ nia01c_color2rgb = hexToRgbArray(nia01c_color2);} else {nia01c_color2rgb = rgbToRgbArray(nia01c_color2);}
						nia01c_color1luminance = luminance(nia01c_color1rgb.r, nia01c_color1rgb.g, nia01c_color1rgb.b);
						nia01c_color2luminance = luminance(nia01c_color2rgb.r, nia01c_color2rgb.g, nia01c_color2rgb.b);
						// Calcul ratio
						nia01c_ratio = nia01c_color1luminance > nia01c_color2luminance ? ((nia01c_color2luminance + 0.05) / (nia01c_color1luminance + 0.05)) : ((nia01c_color1luminance + 0.05) / (nia01c_color2luminance + 0.05));
						nia01c_ratio_inv = 1/nia01c_ratio;
						//console.log(color1+" vs "+color2+" = "+ nia01c_ratio_inv)
						if(nia01c_ratio_inv < 4.5){
							if(debug_flag) console.log("01C - FAIL 3.2.1 Standard ratio : "+nia01c_ratio_inv+" ("+nia01c_color1+" vs "+nia01c_color2+")");
							setItemOutline(nia01c_nodes[i],"orange","nia01c1","01-C");
							nia01c_flag1 = true;
						}
						if(nia01c_color1 == "rgb(0, 0, 0)" && nia01c_color2 != "rgb(255, 255, 255)"){
		...
		if(nia01c_flag1 == true) {
		  setItemToResultList("dev","<li><a href='#' data-destination='nia01c1' class='result-focus label-orange'>01-C</a> : Présence d'élément placeholder insuffisament contrasté</li>");
		}
		if(nia01c_flag2 == true) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01c2' class='result-focus label-yellow'>01-C</a> : Vérifier si l'élément placeholder est suffisament contrasté</li>");
		}
		if(nia01c_flag3 == true) {
		  setItemToResultList("man","<li><a href='#' data-destination='nia01c3' class='result-focus label-yellow'>01-C</a> : Vérifier si l'élément placeholder possède une opacité suffisante</li>");
		}
	}

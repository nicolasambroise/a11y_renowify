...
function check_part_06() {
  ...
  if (!only_redactor && !only_error && isAEM) {
    const nia06g3_nodes = document.querySelector(
  ...
  if (!only_redactor && isAEM) {
    const nia06g4_nodes = document.querySelector(
      'footer a[href$="accessibilite.html"]'
    );
    if (nia06g4_nodes == null) {
      setItemToResultList(
        'nc',
        "<li><a href='#' data-destination='nia06g4' class='result-focus label-red'>06-G</a> : Absence de la déclaration d'accessibilité dans le footer </li>"
      );
	  setItemOutline(nia06g4_nodes, 'red', 'nia06g4', '06-G');
    }
  ...
  if (!only_error) {
    const nia06i_nodes = document.querySelectorAll(
    ...
    if (nia06i_flag == true) {
      setItemToResultList(
        'nth',
        "<li><a href='#' data-destination='nia06i' class='result-focus label-yellow'>06-I</a> : Présence d'espaces pour créer des effets de marges ou d'alignement (touche espace ou retour à la ligne) [<a href='https://accessibilite.public.lu/fr/raweb1/criteres.html#test-10-1-3' target='_blank'>RAWeb 10.1.3</a>]</li>"
      );
    }
  }
